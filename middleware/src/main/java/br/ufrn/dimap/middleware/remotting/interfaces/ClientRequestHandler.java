...
public interface ClientRequestHandler {
	...
	ByteArrayInputStream sendCallback(String host, int port, ByteArrayOutputStream msg, Callback callback) throws RemoteError;
	 ...
	 * @return the server reply
	 */
	ByteArrayInputStream sendAsync(String host, int port, ByteArrayOutputStream msg, InvocationAsynchronyPattern pattern) throws RemoteError;

	/**
	 * @return the poll object
	 */
	PollObject getPollObject();

	/**
	 * @param pollObject the pollObject to set
	 */
	void setPollObject(PollObject pollObject);
	
	/**
	 * @return the default protocol
	 */
	ClientProtocolPlugin getDefaultProtocol();

	/**
	 * @param protocol the default protocol to set
	 * @throws RemoteError if any error occurs when changing the Protocol
	 */
	void setDefaultProtocol(ClientProtocolPlugin protocol) throws RemoteError;
	 ...
	 * @return the protocol
	 */
	ClientProtocolPlugin getProtocol(String host);
	 ...
	 */
	void setProtocol(String host, ClientProtocolPlugin protocol) throws RemoteError, UnknownHostException;
	 ...
	 * @return the protocol
	 */
	ClientProtocolPlugin getProtocol(String host, int port);
	 ...
	 * @throws UnknownHostException if it didn't find the specified host
	 */
	void setProtocol(String host, int port, ClientProtocolPlugin protocol) throws RemoteError, UnknownHostException;
